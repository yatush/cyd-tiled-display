...
Write-Host "Updating files (just in case)..."
docker cp ../esphome "${containerName}:/app/"
docker cp ../configurator "${containerName}:/app/"

Write-Host ""
Write-Host "---------------------------------------------------"
Write-Host "NoVNC URL:      http://localhost:6080/vnc.html"
Write-Host "Configurator:   http://localhost:8099"
Write-Host "---------------------------------------------------"
Write-Host ""
